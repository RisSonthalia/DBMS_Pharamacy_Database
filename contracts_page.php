...
<head>
    ...
    <title>MedMaster - Doctor Page</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <main>
        <div class="select">
            ...
            <button onclick="registerContract()">Register Contract</button><br>
    ...
    <script>
        ...
        function getData() {
            // Redirect to the page to fetch data
            window.location.href = "get_contract_data.php";
        }
    </script>
</body>
